...
namespace OpenSRSLib
{
    ...
    {
        public RegisterNewDefault(string domain, short period, ContactSetUS owner, List<string> nameserverList = null, ContactSetUS admin = null, ContactSetUS billing = null, ContactSetUS tech = null)
        {
            this.domain = domain;
            this.period = period;
            this.owner = owner;
